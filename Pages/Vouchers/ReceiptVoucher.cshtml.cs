...
namespace AccountManagementSystem.Pages.Vouchers
{
    ...
    public class ReceiptVoucherModel : PageModel
    {
        private readonly IVoucherService _voucherService;
        private readonly IAccountService _accountService;

        public ReceiptVoucherModel(IVoucherService voucherService, IAccountService accountService)
        {
        ...
        public async Task OnGetAsync()
        {
            ...
            VoucherViewModel.Voucher.VoucherType = "RECEIPT";
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            VoucherViewModel.Voucher.VoucherNumber = $"RV-{DateTime.Today:yyyyMMdd}-{Guid.NewGuid().ToString().Substring(0, 4).ToUpper()}";
